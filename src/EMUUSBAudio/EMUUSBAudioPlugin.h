...
#ifndef __EMUUSBAudio__EMUUSBAudioPlugin__
#define __EMUUSBAudio__EMUUSBAudioPlugin__
...
public:
	...
	IOReturn			pluginDeviceRequest (IOUSBDevRequest * request, Completion * completion = NULL);
...
#endif /* defined(__EMUUSBAudio__EMUUSBAudioPlugin__) */
