...
* Only works the first use. If you start sample the second time, distortion appears #7. Turn off the EMU,
wait 15 seconds and turn on again if you want to make more samples.
